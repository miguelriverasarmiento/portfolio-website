    ...
    <div className="mx-auto py-10 px-8 bg-gray-400">
        ...
        <div className="grid place-items-center grid-cols-1 md:grid-cols-2 gap-6">
            ...
            shadow-2xl shadow hover:shadow-xl text-teal-950'>
                Este proyecto es una pagina web de una tienda
                online de instrumentos musicales. Utiliza el hook
                useContext para manejar metodos y variables globalmente
                Esta hecho con react, javascript, html y tailwind.css.
