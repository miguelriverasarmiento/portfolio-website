        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[30px] sm:gap-[50px] md:gap-[80px]">
          ...
          <div className="col-span-2">
              ...
              <div className="grid gap-6 text-[14px] sm:text-[16px] md:text-[19px]">
                <div className="flex flex-row gap-2 font-normal text-slate-300">
                  <div className="text-[22px] w-[22px] md:mt-1">
                    <CiCalendarDate className="text-red-800" />
                  </div>
                  Birth&nbsp;:{" "}
                ...
                <div className="flex flex-row gap-2 font-normal text-slate-300">
                  ...
                  Study&nbsp;:{" "}
                  <div className="gap-2 text-slate-300">
                    Master JavaScript and TypeScript on Udemy
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-[800px]">
              <h2 className="font-medium mt-14 mb-10 text-slate-300 text-[16px] sm:text-[19px] md:text-[22px]">
                Hello!{" "}
              </h2>
              <p className="text-slate-300 font-normal text-[14px] sm:text-[16px] md:text-[19px]">
                My name is Miguel Rivera. I am a frontend developer with four
                years of experience in JavaScript, React, and TypeScript. I
                design user interfaces and perform code maintenance.
              </p>
